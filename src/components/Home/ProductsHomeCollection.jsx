export function ProducsHomeCollection () {
    return (
        <section>
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
              <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">
                Coleccion Primavera 2023
              </h2>

              <p className="mt-4 max-w-md text-gray-500">
                La primavera ha llegado y con ella, una explosión de color, vitalidad y estilo. En TiendaX, estamos emocionados de presentarte nuestra colección de ropa de primavera 2023, una celebración de la temporada de renacimiento y transformación.
              </p>
            </header>
