export function ProducsCollection () {
    return (
        <>
...
*/}
        ...
        <section>
            <div className="px-4 py-8 mx-auto sm:py-12 sm:px-6 lg:px-8 bg-gray-900 ">
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
                <div className="grid p-6 bg-gray-900 rounded place-content-center sm:p-8">
                    <div className="max-w-md mx-auto text-center lg:text-left">
                    <header>
                        <h2 className="text-xl font-bold text-white sm:text-3xl">Nuevas Remeras</h2>
                ...
                <div className="lg:col-span-2 lg:py-8">
                    ...
                    alt=""
                    className="transition duration-500 group-hover:scale-105 object-cover w-full rounded aspect-square"
                    />
